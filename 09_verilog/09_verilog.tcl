...
#
# 09_verilog.tcl: Tcl script for re-creating project 'vivado_project'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "${origin_dir}/src/counter.sv" \
   "${origin_dir}/src/traffic.sv" \
   "${origin_dir}/src/traffic_tb.sv" \
   "${origin_dir}/src/counter_tb.sv" \
  ]
  foreach ifile $files {
...
set script_file "09_verilog.tcl"
...
set files [list \
 [file normalize "${origin_dir}/src/counter.sv"] \
 [file normalize "${origin_dir}/src/traffic.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/counter.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/traffic.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set files [list \
 [file normalize "${origin_dir}/src/traffic_tb.sv"] \
 [file normalize "${origin_dir}/src/counter_tb.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/src/traffic_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/counter_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "top" -value "traffic_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
